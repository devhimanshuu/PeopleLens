 ...
 *
 * Kept in one place so the global prefix, Passport strategy names and
 * metadata keys can never drift between the bootstrap, guards and decorators.
 */
...
/** Passport strategy name registered by {@link JwtStrategy}. */
